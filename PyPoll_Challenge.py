...
file_to_load = os.path.join("/Users/veronica/Downloads/Bootcamp/Week 3/Resources", "election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("/Users/veronica/Downloads/Bootcamp/Week 3/analysis", "election_analysis.txt")
